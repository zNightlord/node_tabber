...
## Installation
Download this repository([link](https://github.com/williamchange/node_tabber/archive/refs/heads/master.zip)) and install from Blender's preferences, just like any other add-on (no need to unzip)